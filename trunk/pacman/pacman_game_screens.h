	...
	*********************************************************************************************************/
	...
	private:
		...
		enum EditorMode
		{
			...
			k_editorMode_GridCellSizing, //изменение размера ячейки сетки (C + UP/DOWN/LEFT/RIGHT)
			k_editorMode_GridCellsTweak, //изменение количества ячеек по горизонтали и вертикали (CTRL + UP/DOWN/LEFT/RIGHT)
			k_editorMode_PillsPlacement,//расстановка пилюль (еды) (1 + кликнуть мышью в ячейку сетки)
			k_editorMode_ObstaclePlacement //расстановка препятствий (2 + кликнуть мышью в ячейку сетки)
		};
