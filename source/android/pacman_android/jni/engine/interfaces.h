...
namespace Pegas
{
		...
		************************************************************************************************************/
		...
		{
			const uint32 k_readOnly = 0;
			const uint32 k_writeOnly = 1;
			const uint32 k_readWrite = 2;
			const uint32 k_appendOnly = 3;
			const uint32 k_readAndAppend = 4;
		};
		...
		public:
			...
			virtual void terminateProcess(const ProcessHandle& handle) = 0;
